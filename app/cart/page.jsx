...
const page = () => {
  return (
    <section className='bg-gradient-to-r from-red-50 to-blue-100 h-screen p-4'>
      <div class='mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 bg-white rounded-2xl shadow-md'>
              ...
              <li class='flex items-center gap-4'>
                ...
                <div class='flex flex-1 items-center justify-end gap-2'>
                  ...
                  <button class='text-gray-600 transition hover:text-red-600'>
                    <span class='sr-only'>הסר פריט</span>
