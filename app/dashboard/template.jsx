  ...
  return (
    <div className='flex justify-center h-screen'>
      <div className='my-8 grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 border'>
              ...
              <div className='h-auto w-72'>
                ...
                <nav className='mt-10 px-6'>
                  <Link
                    ...
                    className='hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors duration-200 text-gray-800 border-r-2 border-gray-600 bg-gray-100'
                  >
                    <svg
                      width='20'
                      height='20'
                  ...
                  <Link
                    href={'/dashboard'}
                    className='hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors duration-200 text-gray-600'
                  >
                    <svg
                      width='20'
                      height='20'
                    ...
                    <span className='mx-4 text-lg font-normal'>נתונים</span>
                    <span className='flex-grow text-right'></span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className='mx-4 text-lg font-normal'>הוספת פריט</span>
                    <span className='flex-grow text-right'></span>
                  </Link>
                  <a
                    className='hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors duration-200 text-gray-600'
                  ...
                  >
                    ...
                    <span className='mx-4 text-lg font-normal'>הזמנות</span>
        ...
        <div className='bg-slate-50 flex-auto flex justify-center col-span-3'>
          {children}
        </div>
      </div>
    </div>
